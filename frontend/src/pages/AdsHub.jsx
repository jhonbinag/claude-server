...
export default function AdsHub() {
  ...
  if (!isAuthenticated) return <AuthGate icon="⚡" title="Ads" subtitle="Open this app from GHL to access ads tools." />;
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: '#0f0f13' }}>
      ...
      <div style={{ flex: 1, minHeight: 0, overflow: 'hidden' }}>
        {tab === 'generator' ? <AdsGenerator /> : <AdLibrary />}
      </div>
    </div>
  );
}
